...
dat <- read.csv('BatCoV-assoc_compatible.csv', stringsAsFactors=FALSE)
host <- read.csv('Han-BatTraits_compatible.csv',stringsAsFactors=FALSE)
...
## interaction matrix
intMatFull <- as.data.frame.matrix(table(datEdge[,1], datEdge[,2]))
intMatFull$dumb <- NULL
